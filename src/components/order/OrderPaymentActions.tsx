...
// ------------------------------------------------------------
// Slot aksi bayar wizard /order: widget Cloudflare Turnstile + tombol
// bayar sesuai metode terpilih di langkah 2. Dipakai sebagai slot
// "actions" di dalam kartu OrderSummary.
