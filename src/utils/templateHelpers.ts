...
export const DEFAULT_PHOTOS = {
  groom: 'https://r2.loverse.id/defaults/img/ddeac34add.jpg',
  bride: 'https://r2.loverse.id/defaults/img/be5e4750ac.jpg',
  cover: 'https://r2.loverse.id/defaults/img/1772b3133b.jpg',
  gallery: [
    'https://r2.loverse.id/defaults/img/146c15097b.jpg',
    'https://r2.loverse.id/defaults/img/9a293ef1a6.jpg',
    'https://r2.loverse.id/defaults/img/0150ee7a32.jpg',
    'https://r2.loverse.id/defaults/img/3c8de55846.jpg',
  ],
  audio: 'https://r2.loverse.id/defaults/audio/ee2e74c72c.mp3',
} as const;
