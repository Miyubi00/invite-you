                                ...
                                <div className="flex flex-col md:flex-row items-center gap-8 group">
                                    ...
                                    <div className="w-full md:w-1/2 text-center md:text-left px-4">
                                        <div>
                                            ...
                                            <p className="text-[#D7CCC8] text-sm opacity-80">
                                                {data?.venue_address}
                                            </p>
                                        </div>
                                    </div>
                            ...
                            {banks.map((bank, i) => (
                                <div key={i} className="flex flex-col md:flex-row justify-between items-center bg-[#2c241b] p-4 text-[#D4AF37]">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button onClick={() => navigator.clipboard.writeText(bank.number)} className="hover:text-white transition"><Copy size={14} /></button>
                                    </div>
                                </div>
                            ))}
                        </div>
