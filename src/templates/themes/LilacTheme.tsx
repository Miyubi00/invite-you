...
export default function KoreanMinimalTheme({ groom, bride, date, guestName, data }: TemplateProps) {
        ...
        <section className="px-6 py-8 space-y-4">
             ...
             <div className="bg-[#E1E8E5]/40 p-6 rounded-2xl flex items-start gap-4">
                 ...
                 <div>
                     ...
                     <p className="font-kr-sans text-sm text-[#6B7280] mt-1 flex items-center gap-2">
                         <Clock size={14}/> {schedule.akadTime}
                     </p>
                 </div>
             </div>
             ...
             <div className="bg-[#EBE4F2]/50 p-6 rounded-2xl flex items-start gap-4">
                 ...
                 <div>
                     ...
                     <p className="font-kr-sans text-sm text-[#6B7280] mt-1 flex items-center gap-2">
                         <Clock size={14}/> {schedule.resepsiTime}
                     </p>
                 </div>
             </div>

             {/* Venue */}
             <div className="bg-[#EBE4F2]/50 p-6 rounded-2xl flex items-start gap-4 mt-4">
                 <div className="bg-white p-3 rounded-full text-[#3B82F6] shadow-sm">
                     <MapPin size={18} fill="#3B82F6" className="opacity-50"/>
                 </div>
                 <div>
                     <h3 className="font-kr-sans font-bold text-[#374151] text-lg">Lokasi</h3>
                     <p className="font-kr-sans text-sm text-[#6B7280] mt-1 flex items-start gap-2">
                         <MapPin size={14} className="shrink-0 mt-0.5"/> {resolveVenue(data).name} - {resolveVenue(data).address}
                     </p>
                     <a href={resolveVenue(data).mapsLink} target="_blank" className="inline-block mt-3 text-xs bg-white px-3 py-1.5 rounded-md border border-[#E5E7EB] text-[#4B5563]">
                         Google Maps
                     </a>
                 </div>
             </div>
