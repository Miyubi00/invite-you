...
export default function ElegantBotanicalTheme({ groom, bride, date, guestName, data }: TemplateProps) {
  ...
  const timeLeft = useCountdown(date);
    ...
    // menggantikan useEffect autoplay lama.
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            ...
                            <div className="bg-[#F0F4F1] text-[#1A3C34] p-8 md:p-10 rounded-sm shadow-xl text-center border-t-8 border-[#C5A059]">
                                ...
                                <div className="space-y-4 font-body text-sm md:text-base">
                                    <div className="flex flex-col items-center">
                                        ...
                                        <span className="font-bold uppercase tracking-wider">{formattedAkadDate}</span>
                                    </div>
                                    <div className="w-full h-[1px] bg-gray-200"></div>
                                    <div className="flex flex-col items-center">
                                        <span className="font-bold text-lg">{schedule.akadTime}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-[#132c26] border border-[#C5A059]/30 text-[#F0F4F1] p-8 md:p-10 rounded-sm shadow-xl text-center relative overflow-hidden">
                                ...
                                <div className="space-y-4 font-body text-sm md:text-base">
                                    <div className="flex flex-col items-center">
                                        <Calendar className="w-6 h-6 text-[#C5A059] mb-2" />
                                        <span className="font-bold uppercase tracking-wider">{formattedResepsiDate}</span>
                                    </div>
                                    <div className="w-full h-[1px] bg-white/10"></div>
                                    <div className="flex flex-col items-center">
                                        <span className="font-bold text-lg">{schedule.resepsiTime}</span>
                                    </div>
                                </div>
                            </div>                        </div>
                            ...
                            <div className="bg-[#132c26] border border-[#C5A059]/30 text-[#F0F4F1] p-8 md:p-10 rounded-sm shadow-xl text-center relative overflow-hidden">
                                <div className="flex flex-col items-center text-gray-300 px-4">
                                    ...
                                    <div className="flex flex-col">
                                        <span className="font-bold text-lg">{resolveVenue(data).name}</span>
                                        <span className="text-sm opacity-80">
                                            {resolveVenue(data).address}
                                        </span>
                                    </div>
                                </div>
                                <a href={resolveVenue(data).mapsLink} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 mt-6 text-[#C5A059] hover:text-white border border-[#C5A059] hover:bg-[#C5A059] px-6 py-2 rounded transition-all text-xs font-bold uppercase tracking-widest">
