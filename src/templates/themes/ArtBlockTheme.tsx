...
const Badge = ({  text, color = "bg-yellow-400", rotate = "rotate-12"  }: { text: string; color?: string; rotate?: string })  => (
...
const SectionTitle = ({  title, subtitle, color = "text-black"  }: { title: string; subtitle: string; color?: string })  => (
...
const CoverSection = ({  data, date, groom, bride, guestName  }: { data?: TemplateData; date: string; groom: string; bride: string; guestName: string })  => (
    ...
    <section className="min-h-screen relative flex flex-col border-b-4 border-black bg-[#FF3366]">
        ...
        <div className="flex-1 relative overflow-hidden flex flex-col items-center pt-8">
            ...
            <div className="relative w-[90%] md:w-[60%] aspect-[3/4] md:aspect-square bg-gray-200 border-4 border-black shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] -mt-4 md:-mt-10 z-0">
                ...
                <img src={data?.cover_photo || DEFAULT_PHOTOS.cover} className="w-full h-full object-cover grayscale contrast-125" alt="Cover" />
...
const ProfileSection = ({  data, groom, bride  }: { data?: TemplateData; groom: string; bride: string })  => (
                ...
                <div className="relative group">
                    ...
                    <div className="relative bg-white border-4 border-black p-4 flex flex-col">
                        ...
                        <div className="aspect-[3/4] bg-gray-200 overflow-hidden border-2 border-black mb-4">
                            ...
                            <img src={data?.groom_photo || DEFAULT_PHOTOS.groom} alt="Groom" className="w-full h-full object-cover grayscale hover:grayscale-0 transition duration-500" />
                ...
                <div className="relative group mt-8 md:mt-0">
                    ...
                    <div className="relative bg-white border-4 border-black p-4 flex flex-col">
                        ...
                        <div className="aspect-[3/4] bg-gray-200 overflow-hidden border-2 border-black mb-4">
                            ...
                            <img src={data?.bride_photo || DEFAULT_PHOTOS.bride} alt="Bride" className="w-full h-full object-cover grayscale hover:grayscale-0 transition duration-500" />
...
const EventSection = ({  data, date  }: { data?: TemplateData; date?: string })  => {
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
                    ...
                    <div className="flex-1 border-2 border-black p-4 border-dashed relative">
                        ...
                        <p className="font-mono text-sm">{formattedAkadDate}</p>

                        <h3 className="font-display text-2xl">{schedule.akadTime}</h3>
                ...
                <div className="flex flex-col md:flex-row gap-4 items-start md:items-center">
                    ...
                    <div className="flex-1 border-2 border-black p-4 border-dashed bg-black text-white">
                        ...
                        <p className="font-mono text-sm text-gray-300">{formattedResepsiDate}</p>

                        <h3 className="font-display text-2xl">{schedule.resepsiTime}</h3>
...
const CountdownSection = ({  timeLeft  }: { timeLeft: TimeLeft })  => (
...
const LocationSection = ({  data  }: { data?: TemplateData })  => (
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white border-4 border-black p-2 shadow-[8px_8px_0px_black]">
                ...
                <div className="border-2 border-dashed border-black p-6 md:p-10 flex flex-col items-center text-center">
                    ...
                    <h2 className="font-display text-4xl md:text-6xl mb-4">{resolveVenue(data).name}</h2>

                    <p className="font-mono text-sm md:text-base max-w-lg mb-8">{resolveVenue(data).address}</p>
...
const RsvpSection = ({  onRsvpSubmit, submittedData, data  }: { onRsvpSubmit?: (payload: RsvpPayload) => Promise<void>; submittedData?: RsvpRow | null; data?: TemplateData })  => {
                        ...
                        {submittedData ? (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-4 font-mono">
                                ...
                                <div>
                                    ...
                                    {/* Indikator karakter dengan gaya bold sesuai tema border */}
...
const GiftSection = ({  data  }: { data?: TemplateData })  => {
            ...
            <div className="grid md:grid-cols-2 gap-4">
                ...
                {resolveBanks(data).map((bank, i) => (
                    ...
                    <div key={i} className="bg-white border-2 border-black p-4 flex items-center justify-between shadow-[4px_4px_0px_rgba(0,0,0,0.2)] hover:shadow-[4px_4px_0px_black] transition-all">
                        ...
                        <button onClick={() => copyRek(bank.number)} className="bg-yellow-400 border-2 border-black p-2 hover:bg-yellow-300 active:translate-y-1 transition">
...
const GallerySection = ({  data  }: { data?: TemplateData })  => (
...
const BackCover = ({  groom, bride, date  }: { groom: string; bride: string; date: string })  => (
...
export default function RetroMagazineTheme({
    ...
    return (
        ...
        `}</style>
            ...
            <EventSection data={data} date={date} />
