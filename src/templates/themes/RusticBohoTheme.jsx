      ...
      <div className={`transition-opacity duration-1000 ${isOpen ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <section className="relative h-screen flex flex-col items-center justify-center text-center overflow-hidden">
            ...
            <div className="relative z-10 text-[#F0F4F1] px-6 animate-fade-up mt-20">
                ...
                <p className="font-body mt-6 text-lg tracking-wide border-y border-[#C5A059] py-2 inline-block px-8">
                   {formattedDate}
                </p>
            </div>
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-12 md:gap-24">
                    ...
                    <div className="text-center group w-full max-w-sm">
                        ...
                        <p className="font-body text-sm text-[#C5A059] mt-2 font-bold uppercase">The Groom</p>
                    ...
                    <div className="text-center group w-full max-w-sm">
                        ...
                        <p className="font-body text-sm text-[#C5A059] mt-2 font-bold uppercase">The Bride</p>
