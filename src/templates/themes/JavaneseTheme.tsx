...
import { MapPin, Calendar, Clock, Music, Play, Pause, ChevronDown, Heart, Copy } from 'lucide-react';
...
export default function JavaneseTheme({ groom, bride, date, guestName, data }: TemplateProps) {
            ...
            >
                    ...
                    <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-center gap-16">
                        ...
                        <div className="text-center w-full max-w-sm">
                            ...
                            <div className="mt-8">
                                ...
                                <p className="font-royal text-xs text-[#556B2F] uppercase tracking-widest mt-2 font-bold">Putra dari</p>
                        ...
                        <div className="text-center w-full max-w-sm">
                            ...
                            <div className="mt-8">
                                ...
                                <p className="font-royal text-xs text-[#556B2F] uppercase tracking-widest mt-2 font-bold">Putri dari</p>
                ...
                <section className="py-24 px-4 bg-[#2c241b] text-[#FDFBF7] relative overflow-hidden">
                            ...
                            <div className="space-y-12">
                                ...
                                <div className="flex flex-col md:flex-row items-center gap-8 group">
                                    <div className="w-full md:w-1/2 text-center md:text-right px-4">
                                        ...
                                        <div className="text-[#D7CCC8] text-sm space-y-1">
                                            <p>{formattedAkadDate}</p>
                                            <p className="font-bold">{schedule.akadTime}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="flex flex-col md:flex-row items-center gap-8 group">
                                    ...
                                    <div className="w-full md:w-1/2 text-center md:text-left px-4 order-3">
                                        ...
                                        <div className="text-[#D7CCC8] text-sm space-y-1">
                                            <p>{formattedResepsiDate}</p>
                                            <p className="font-bold">{schedule.resepsiTime}</p>
                                        </div>
                                    </div>
                                </div>                            </div>
                        </div>
                    ...
                    <div className="mt-8 px-4 text-center">
                        <h3 className="font-jawa text-2xl text-[#D4AF37] mb-4">Papan Kawruh</h3>
                        <p className="text-[#F5F5F5] font-medium mb-1">{resolveVenue(data).name}</p>
                        <p className="text-[#D7CCC8] text-sm opacity-80 mb-4">{resolveVenue(data).address}</p>
                        <a href={resolveVenue(data).mapsLink} target="_blank" className="inline-block text-[10px] text-[#D4AF37] border-b border-[#D4AF37] pb-1 uppercase tracking-widest">
                            Peta Lokasi
                        </a>
                    </div>
                </section>
                            ...
                            {banks.map((bank, i) => (
                                <div key={i} className="flex flex-col md:flex-row justify-between items-center bg-[#2c241b] p-4 text-[#D4AF37]">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <button onClick={() => copyRek(bank.number)} className="hover:text-white transition"><Copy size={14} /></button>
                                    </div>
                                </div>
                            ))}
                        </div>
